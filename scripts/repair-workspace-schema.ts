...
try {
  ...
  await client.query(`
    ...
    ALTER TYPE "PayrollStatus" ADD VALUE IF NOT EXISTS 'ATTENDANCE_LOCKED';
    ALTER TYPE "PayrollStatus" ADD VALUE IF NOT EXISTS 'CALCULATED';
    ALTER TYPE "PayrollStatus" ADD VALUE IF NOT EXISTS 'HR_REVIEW';
    ALTER TYPE "PayrollStatus" ADD VALUE IF NOT EXISTS 'FINANCE_APPROVED';
    ALTER TYPE "PayrollStatus" ADD VALUE IF NOT EXISTS 'LOCKED';
    ALTER TYPE "PayrollStatus" ADD VALUE IF NOT EXISTS 'PAYSLIPS_PUBLISHED';
    ALTER TYPE "PayrollStatus" ADD VALUE IF NOT EXISTS 'BANK_EXPORTED';
    ALTER TYPE "PayrollStatus" ADD VALUE IF NOT EXISTS 'REVERSED';
    ALTER TABLE "PayrollRun" ADD COLUMN IF NOT EXISTS "periodStart" DATE;
    ALTER TABLE "PayrollRun" ADD COLUMN IF NOT EXISTS "periodEnd" DATE;
    ALTER TABLE "PayrollRun" ADD COLUMN IF NOT EXISTS "attendanceLockId" TEXT;
    ALTER TABLE "PayrollRun" ADD COLUMN IF NOT EXISTS "calculatedAt" TIMESTAMP(3);
    ALTER TABLE "PayrollRun" ADD COLUMN IF NOT EXISTS "hrReviewedById" TEXT;
    ALTER TABLE "PayrollRun" ADD COLUMN IF NOT EXISTS "hrReviewedAt" TIMESTAMP(3);
    ALTER TABLE "PayrollRun" ADD COLUMN IF NOT EXISTS "financeApprovedById" TEXT;
    ALTER TABLE "PayrollRun" ADD COLUMN IF NOT EXISTS "financeApprovedAt" TIMESTAMP(3);
    ...
    ALTER TABLE "PayrollRun" ADD COLUMN IF NOT EXISTS "reversedRunId" TEXT;
    ALTER TABLE "PayrollRun" ADD COLUMN IF NOT EXISTS "bankExportedAt" TIMESTAMP(3);
    ALTER TABLE "PayrollRun" ADD COLUMN IF NOT EXISTS "workflowInstanceId" TEXT;
    ALTER TABLE "PayrollRun" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
